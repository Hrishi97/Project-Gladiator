...
//	private String jobId;
	...
	public String registerEmp(HttpServletRequest req) {
		...
		String strEmpFname = req.getParameter("firstName");
		String strEmpLname = req.getParameter("lastName");
		String strEmpEmail = req.getParameter("email");
		String strEmpJobId = req.getParameter("jobId");
		Employees emp = new Employees();
		emp.setEmpId(Integer.parseInt(strEmpId));
		emp.setFirstName(strEmpFname);
		emp.setLastName(strEmpLname);
		emp.setEmail(strEmpEmail);
		emp.setJobId(strEmpJobId);
		//emp.setHireDate();
